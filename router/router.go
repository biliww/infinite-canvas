...
func New() *gin.Engine {
	...
	v1.POST("/image-tasks/generations", gin.WrapF(handler.AIImageTaskGeneration))
	v1.POST("/image-tasks/edits", gin.WrapF(handler.AIImageTaskEdit))
	v1.GET("/image-tasks", gin.WrapF(handler.AIImageTasks))
